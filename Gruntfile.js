		...
		*/
		grunt.initConfig({
			...
			buildcontrol: {
				...
				pages: {
					options: {
						remote: 'git@github.com/Full360Solutions/angularjs-typeahead-dropdown.git',
						branch: 'gh-pages'
					}
				}
			},
			...
			uglify: {
				...
				build: {
					files:  {},
					src:    'src/angularjs-typeahead-dropdown.js',
					dest:   'dist/angularjs-typeahead-dropdown.min.js'
				}
			}
		});
